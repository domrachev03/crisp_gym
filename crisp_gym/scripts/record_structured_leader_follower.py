...
def main():  # noqa: C901
    ...
    p.add_argument("--timing-log", type=str, default=None,
                   help="If set, dump per-frame loop timings to this jsonl (data_fn vs queue.put "
                        "vs total, writer queue depth, and data_fn sub-stages) for diagnosing stalls.")
    ...
    try:
        ...
        rm = make_recording_manager(
            ...
            push_to_hub=args.push_to_hub, queue_size=128, timing_log=args.timing_log,
